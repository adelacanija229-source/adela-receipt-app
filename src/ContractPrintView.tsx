    ...
    <div style={styles.overlay}>
      ...
      <div className="a4-page" style={styles.page}>
        ...
        <table style={{ ...styles.table, borderTop: '2px solid black' }}>
          <tbody>
            ...
            <tr>
              ...
              <td style={{ ...styles.td, lineHeight: 1.6 }}>
            ...
            <tr>
              ...
              <td style={{ ...styles.td, padding: 0 }}>
                <div style={{ padding: '6px 8px', borderBottom: '1px solid black', lineHeight: 1.6 }}>
                ...
                {/* 임금 내역 중첩 표 (테두리 없음) */}
                <div style={{ display: 'flex', padding: '6px 8px', fontSize: '0.85rem', borderBottom: '1px solid black' }}>
                  <div style={{ flex: 1.5, lineHeight: 1.8 }}>
                    2. 
                  ...
                  <div style={{ flex: 1, lineHeight: 1.8, paddingLeft: 10 }}>
                     <br/>
                     ...
                     {['목공', '타일', '설비'].includes(contract.workType) && (
                       <div style={{ textAlign: 'right', color: '#cc0000', fontSize: '0.8rem', marginTop: 5 }}>
                         ※ 공구대는 별도 <strong>10만원</strong> 지급한다.
                       </div>
                     )}
                  </div>

                  <div style={{ flex: 0.8, lineHeight: 1.8, textAlign: 'right' }}>
                    1일 총 환산근로시간 : &nbsp;&nbsp;&nbsp; 17.1 시간<br/>
                    <strong style={{ fontSize: '0.9rem' }}>일 당 총 액 : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ₩ {formatKRW(contract.dailyWage)}</strong>
                  </div>
                </div>
        ...
        <div style={styles.footerWrap}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0 20px', fontSize: '0.9rem', lineHeight: 1.8 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                ...
                <strong style={{ fontSize: '1rem' }}>㈜ 아 델 라</strong>
            ...
            <div style={{ flex: 1, paddingLeft: 40 }}>
              ...
              <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                ...
                <strong style={{ fontSize: '1rem', flex: 1, textAlign: 'center' }}>{contract.workerName}</strong>
                <span style={{ marginLeft: 'auto', marginRight: 40 }}>(인)</span>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  page: {
    ...
    padding: '20mm', // 상하좌우 여백
    boxSizing: 'border-box', color: '#000', fontFamily: "'Malgun Gothic', 'Dotum', sans-serif"
  },
  titleContainer: {
  ...
  mainTitle: {
    ...
    padding: '8px 60px', margin: 0, fontSize: '1.6rem', letterSpacing: '8px', fontWeight: 900
  },
  table: {
  ...
  td: {
    border: '1px solid black', padding: '6px 8px', verticalAlign: 'middle', wordBreak: 'keep-all'
  },
  th: {
    fontWeight: 700, textAlign: 'center', letterSpacing: '4px'
  },
  declaration: {
    textAlign: 'center', padding: '10px 0', fontSize: '0.95rem', borderLeft: '2px solid black', borderRight: '2px solid black'
  },
  footerWrap: {
    marginTop: 20, padding: '10px 0'
  },
  footerDate: {
    textAlign: 'center', marginBottom: 30, fontSize: '1rem'
  }
};
